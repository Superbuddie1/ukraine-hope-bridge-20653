...
const translations: Record<Language, Record<string, unknown>> = {
  en: {
    ...
    resources: {
      ...
      yourAssessment: 'Your Assessment Summary',
      status: 'Status',
      surgeryType: 'Surgery Type',
      limbLocation: 'Limb',
      amputationLevelLabel: 'Amputation Level',
      currentStageLabel: 'Current Stage',
      regionLabel: 'Region',
      militaryLabel: 'Military',
      civilianLabel: 'Civilian',
      plannedLabel: 'Planned',
      emergencyLabel: 'Emergency (Trauma)',
      upperLimbLabel: 'Upper Limb',
      lowerLimbLabel: 'Lower Limb',
    },
    dashboard: {
  ...
  uk: {
    ...
    resources: {
      ...
      yourAssessment: 'Ваші відповіді',
      status: 'Статус',
      surgeryType: 'Тип операції',
      limbLocation: 'Кінцівка',
      amputationLevelLabel: 'Рівень ампутації',
      currentStageLabel: 'Поточний етап',
      regionLabel: 'Регіон',
      militaryLabel: 'Військовий',
      civilianLabel: 'Цивільний',
      plannedLabel: 'Планова',
      emergencyLabel: 'Екстрена (травма)',
      upperLimbLabel: 'Верхня кінцівка',
      lowerLimbLabel: 'Нижня кінцівка',
    },
    dashboard: {
